...
def create_target_volume(depth_size, volume_size_H, volume_size_W, ratio, pose_target, K, near=None, far=None):
    device, dtype = pose_target.device, pose_target.dtype

    # compute a depth range on the unit sphere
    H, W, D, B = volume_size_H, volume_size_W, depth_size, pose_target.shape[0]
